    	...
    	while ($row = $res->fetch_assoc()) {
    	    ...
    	    echo '<div class="row photo-collection">';
        	    echo '<div class="col-sm">';
            	    ...
            	    echo '<a href="'.LAYER_2.WARNING_VIEW.'delete_image.php?id='.$row['id'].'&category='.$_GET['category'].'"><button type="button" class="btn btn-danger delete-button">Delete</button></a>';
