  ...
  <body>
    ...
    <div class="card border-danger mb-3 delete-message" style="max-width: 20rem;">
      ...
      <div class="card-body text-danger">
        ...
        <?php 
            echo '<a href="'.LAYER_2.DELETE_SERVICE.'delete_image_proccess.php?category='.$_GET['category'].'&id='. $_GET['id'].'">';
            echo	'<button type="button" class="btn btn-danger">Yes</button>';
            echo '</a>';
            echo '<a href="'.LAYER_2.PAGE_VIEW.'category_details.php?category='.$_GET['category'].'">';
